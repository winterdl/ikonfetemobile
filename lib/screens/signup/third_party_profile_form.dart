...
class ThirdPartySignupProfileForm extends StatefulWidget {
  final GlobalKey<FormState> formKey;
  final Function(String, File, Country) onSaved;
  final String pictureUrl;

  ThirdPartySignupProfileForm({
  ...
  @override
  _ThirdPartySignupProfileFormState createState() =>
      _ThirdPartySignupProfileFormState();
}

class _ThirdPartySignupProfileFormState
    extends State<ThirdPartySignupProfileForm> {
...
class PictureChooser extends StatelessWidget {
