package com.ikonfete.ikonfete.deezer;
...
import com.ikonfete.ikonfete.BuildConfig;
...
public class DeezerApi {
    ...
    DeezerApi(String applicationId, Activity context) {
...
//        this.applicationId = applicationId;
    ...
    void authorize(final MethodChannel.Result result) {
        ...
        if (sessionStore.restore(deezerConnect, context)) {
            ...
            resultMap.put("access_token", deezerConnect.getAccessToken());
            resultMap.put("expires", deezerConnect.getAccessExpires());
            resultMap.put("userId", String.valueOf(deezerConnect.getCurrentUser().getId()));
            result.success(resultMap);
        } else {
            deezerConnect.authorize(context, permissions, new DialogListener() {
                @Override
...
//                    }
                    ...
                    resultMap.put("userId", deezerConnect.getCurrentUser().getId());
                    result.success(resultMap);
                }
    ...
    void getCurrentSession(final MethodChannel.Result result) {
    ...
    void initializeTrackPlayer(MethodChannel.Result result) {
        ...
        deezerTrackPlayer = new DeezerTrackPlayer(context, deezerConnect, new DeezerTrackPlayer.DeezerTrackPlayerEventListener() {
            @Override
