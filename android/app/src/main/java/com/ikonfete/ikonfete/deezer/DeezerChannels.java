...
public class DeezerChannels {
    ...
    public void initialize(Activity context, BinaryMessenger binaryMessenger) {

        deezerApi = new DeezerApi(DEEZER_APPLICATION_ID, context);
            ...
            public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
                switch (methodCall.method) {
                    ...
                    case "getCurrentSession":
                        deezerApi.getCurrentSession(result);
                        break;
                    case "logout":
